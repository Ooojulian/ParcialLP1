...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_todo = 13,                      /* todo  */
  YYSYMBOL_linea = 14,                     /* linea  */
  YYSYMBOL_operacion = 15                  /* operacion  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "RAIZ", "FIN",
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "$accept", "todo", "linea",
  "operacion", YY_NULLPTR
};
...
{
      -8,     0,    -8,    -8,    -1,    -8,     3,    -8,    25,     3,
      12,    -8,     3,     3,     3,     3,    18,    -8,    -7,    -7,
      -8,    -8,    -8
};
...
{
       2,    14,    15,     3,     4,     5,     3,     4,    10,     9,
       6,    16,     0,     6,    18,    19,    20,    21,    12,    13,
      14,    15,     0,    17,    12,    13,    14,    15,     0,    22,
      11,    12,    13,    14,    15
};

static const yytype_int8 yycheck[] =
{
       0,     8,     9,     3,     4,     5,     3,     4,     6,    10,
      10,     9,    -1,    10,    12,    13,    14,    15,     6,     7,
...
{
       0,    13,     0,     3,     4,     5,    10,    14,    15,    10,
      15,     5,     6,     7,     8,     9,    15,    11,    15,    15,
      15,    15,    11
};
...
#line 1096 "calc.tab.c"
  ...
  case 6: /* operacion: NUM  */
#line 39 "calc.y"
        { (yyval.val) = (yyvsp[0].val); }
#line 1102 "calc.tab.c"
    break;

  case 7: /* operacion: RAIZ '(' operacion ')'  */
#line 40 "calc.y"
                             { (yyval.val) = hacer_newton((yyvsp[-1].val)); }
#line 1108 "calc.tab.c"
    break;

  case 8: /* operacion: operacion '+' operacion  */
#line 41 "calc.y"
                              { (yyval.val) = (yyvsp[-2].val) + (yyvsp[0].val); }
#line 1114 "calc.tab.c"
    break;

  case 9: /* operacion: operacion '-' operacion  */
#line 42 "calc.y"
                              { (yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val); }
#line 1120 "calc.tab.c"
    break;

  case 10: /* operacion: operacion '*' operacion  */
#line 43 "calc.y"
                              { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); }
#line 1126 "calc.tab.c"
    break;

  case 11: /* operacion: operacion '/' operacion  */
#line 44 "calc.y"
                              {
        if((yyvsp[0].val) == 0) {
